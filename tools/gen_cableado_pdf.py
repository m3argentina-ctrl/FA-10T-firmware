...
doc = SimpleDocTemplate(
    ...
    title="FA-10T v3.0 — Cableado PCB H1 ↔ Waveshare J8",
    author="Bio Origen", subject="Cableado PCB FA-10T",
)
story = []

# Header
story.append(Paragraph("FA-10T v3.0 — Mapeo de cableado", title_style))
...
story.append(Paragraph(
    "<i>Bio Origen &mdash; FA-10T v3.0 &mdash; documento generado automáticamente "
