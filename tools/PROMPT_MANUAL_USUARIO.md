# PROMPT — Generar Manual de Usuario del Controlador FA-10T v3.0
...
Markdown** para el controlador electrónico **FA-10T v3.0** de la empresa
...
- **Modelo del controlador**: FA-10T v3.0 (Firmware versión 3 fase 4).
...
3. **Introducción** (1-2 páginas): qué es el FA-10T, para qué sirve, a
...
Empezá con `# Manual de Usuario — Controlador FA-10T v3.0` y terminá con
