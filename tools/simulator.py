#!/usr/bin/env python3
# Control ESP32-S3 v3.0 — Standalone PC simulator
#
...
def render(sim: "Sim", uptime_s: float, dt_print: float):
    ...
    print()
    print(bar)
    print(f"  Control ESP32-S3 v3.0 | UP {fmt_hms(uptime_s)} | {state}")
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Control ESP32-S3 v3.0 standalone PC simulator",
...
def main():
    ...
    print(f"Control ESP32-S3 simulator | SP={args.setpoint:.1f} C | duration={args.duration:.0f}s | "
